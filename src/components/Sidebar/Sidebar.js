...
function Sidebar({ lists, colors, addTaskMenuFunctions, removListItem }) {

    return (
        <Fragment>
            <div className="sidebar__alltastk">
                <i>
            ...
            <div className="sidebar__tasks">
                <List lists={lists} colors={colors} removListItem={removListItem} />
            </div>
