...
function Addtask() {
    ...
    return (
        <Fragment>
            <div className="addtask" onClick={hendlerOpenMenu}>
                <i>
            ...
            <div className="addtask__menu" style={{ display: showMenu ? 'block' : 'none' }}>
                <div className="menu__close__btn" onClick={hendlerCloseMenu}>
                ...
                <input placeholder="Назва завдання" className="addtask__menu__input" />
                <div className="addtask__menu__colors">
                    {colors.map(el => {
                        return (
                            <Badge key={el.id} color={el.name} />
                        )
                    })}
                </div>
                <button className="addtask__menu__addbutton" >Добавити</button>
            </div>
        </Fragment>
    );
}
