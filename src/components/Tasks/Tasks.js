...
function Tasks({ activeListItem, renderAll, tasks, colors, lists, cardTaskMenu, removTaskItem, toggleTaskItemCompleted, changeListItemName }) {
    ...
    const addNewTask = (listId, text, completed, hideAddCard) => {
        if (listId && text) {
            const newListItem = {
                id: Date.now(),
                listId,
